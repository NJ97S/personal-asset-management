...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card p-6 shadow-pop transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-300",
  {
    variants: {
      side: {
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn("text-heading-m text-foreground", className)}
    {...props}
  />
));
